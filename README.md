...
- A short and comprehensive description can be found in [this supplement file](https://doi.org/10.1371/journal.pone.0278776.s0019) of [this paper](https://doi.org/10.1371/journal.pone.0278776).
- I provide some examples of NeuroCombat in action in some of my other Github repositories (e.g., preterm-brain-heterogeneity and ThalamusVolumePrematurity).
