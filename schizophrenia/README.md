...
- [Review: why schizophrenia exists from an evolutionary perspective]
- A study by [van den Heuvel et al.](https://doi.org/10.1093/brain/awz330), showing that evolutionary connectivity alterations are linked to schizophrenia and an accessible [scientific commentary](https://doi.org/10.1093/brain/awz353) about it